...
export default function Destacadas() {
    return (
        <>
        <h1 className="text-center text-3xl mt-16 mb-8">Somos una empresa especializada y con excelentes resultados</h1>
        <h1 className="text-center bold text-4xl mt-16 mb-8">Soluciones destacadas</h1>
